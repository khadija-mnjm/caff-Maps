...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
        ...
        <div class="col-md-6 right-box">
            ...
            <form method="POST" action="{{ route('vendeur.login') }}">
                @csrf
                <div class="header-text mb-4">
                    <h2>hello Vendeurs </h2>
                    <p>Nous sommes heureux de vous retrouver.</p>
                </div>
                <div class="input-group mb-3">
                    <input type="email" name="EmailV" class="form-control form-control-lg bg-light fs-6" placeholder="Address Email">
                </div>
                <div class="input-group mb-1">
                    <input type="password" name="mot_de_passV" class="form-control form-control-lg bg-light fs-6" placeholder="Mot de pass">
                </div>
